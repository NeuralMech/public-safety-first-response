...
The intended full system assumes broader public-safety data and additional event categories. The current demo therefore supports:
...
This work was developed as part of a multi-disciplinary team project, with my primary role centered on system design, safety logic, anomaly detection, route planning, and workflow integration.
